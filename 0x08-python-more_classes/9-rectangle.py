...
class Rectangle:
    ...
    def __str__(self):
        """Prints rectangle using `print_symbol`"""
        string = []
    ...
    def __del__(self):
        """Prints a string when instane is deleted"""
        print("Bye rectangle...")
        Rectangle.number_of_instances -= 1
    ...
    def width(self, value):
        """Sets the value a new value to width """
    ...
    def square(cls, size=0):
        """Defines a new Rectangle instance"""
